  ...
  return(
    <div className={cn(
      ...
      <button className={styles.button} onClick={handleFilterButtonClick}>
        <svg className={styles['filter-button']} version="1.0" xmlns="http://www.w3.org/2000/svg"
             width="512" height="512" viewBox="-20 -20 550 550"
             preserveAspectRatio="xMidYMid meet">

          <g transform="translate(0,512) scale(0.1,-0.1)"
             fill={isOpen ? 'currentColor' : 'transparent'} stroke="currentColor" strokeWidth="300">
            <path d="M210 5114 c-70 -11 -101 -27 -139 -71 -64 -72 -86 -167 -56 -241 11
